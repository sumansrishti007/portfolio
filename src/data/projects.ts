...
export const projects: Project[] = [
  {
    ...
    problem:
      'Built a complete simulator with forward/inverse kinematics, trajectory planning with 50 interpolated waypoints, and real-time visualization.',
  ...
  },
  {
    ...
    problem:
      'Built multi-factor authentication system with JWT tokens, OTP-based password recovery, and role-based access control for enterprise ETRM platform.',
  ...
  },
  {
    ...
    problem:
      'Designed weapon control system with 360° servo control, Python GUI, and ESP32 live-streaming module for remote operation and monitoring.',
  ...
  },
  {
    ...
    problem:
      'Built a clean habit tracking app with motivational quotes to help users build consistent daily routines.',
  ...
  },
  {
    ...
    problem:
      'Designed and built a content platform concept for storytelling with clean UI and smooth user experience.',
    tech: ['HTML', 'CSS', 'JavaScript'],
    period: '2022',
  ...
  },
  {
    ...
    problem:
      'Analyzed Genetic Algorithm, Gold-Rush Optimization, and Energy Valley Optimizer on Quanser Aero system with Fractional Order PID controllers.',
